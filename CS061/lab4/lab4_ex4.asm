...
LD R5, SUB_PRETTY_PRINT_ARRAY_3800 ; R5 <- x3800
JSRR R5 ; SUB_PRETTY_PRINT_ARRAY()
...
SUB_PRETTY_PRINT_ARRAY_3800 .FILL x3800 ; SUB_PRETTY_PRINT_ARRAY function
...
; Parameter (R1): The starting address of the array. This should be unchanged at the end of the subroutine!
; Postcondition: Prints out “=====” (5 equal signs), prints out the array, and afterprints out “=====” again.
; Return Value (None)
;-------------------------------------------------------------------------
...
EQUALS .STRINGZ "====="
SUB_PRINT_ARRAY_3600_1 .FILL x3600   ; SUB_PRINT_ARRAY function
R7_BACKUP .BLKW #1
